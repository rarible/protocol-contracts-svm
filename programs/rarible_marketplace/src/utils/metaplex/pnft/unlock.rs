...
use mpl_token_metadata::{
    accounts::Metadata,
    instructions::UnlockBuilder,
    types::{ProgrammableConfig, TokenStandard, UnlockArgs},
};

use crate::utils::FreezeNft;

use super::utils::PnftParams;

pub fn metaplex_unlock<'info>(
    ...
    invoke_signed(&unlock_ix, &account_infos, ctx.signer_seeds)?;

    Ok(())
}

#[derive(Accounts)]
pub struct MetaplexUnlock<'info> {
